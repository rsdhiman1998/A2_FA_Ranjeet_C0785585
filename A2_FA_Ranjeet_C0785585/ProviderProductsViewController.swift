//
//  ProviderProductsViewController.swift
...
class ProviderProductsViewController: UIViewController {
...
//        
//        let predicate = NSPredicate(format: "prodProvider CONTAINS[cd] %@", providerName)
//     
//        do{
